...
export const CONTENT_FONT_FAMILY = "Roboto, sans-serif"
...
// border colors
export const BORDER_COLOR = "#cfd0d6"

// text colors
export const PRIMARY_TXT_COLOR = "#15357a"
export const SECONDARY_TXT_COLOR = "#2c71f0"
